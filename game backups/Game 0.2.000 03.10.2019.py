            ...
            if a == 1:
                while True:
                    ...
                    if o == 2:
                        ...
                        print('Levels increase statistics (health and attack) but also decrease experience gain a')
                        print('bit and increase experience required to gain another level.')
                        print()
                        print()
                        print()
                        print()
                    ...
                    if o == 3:
                        ...
                        print('Damage dealt is calculated by damage and damage cariable of attacker and is')
