...
flags = {}    #value to store flags/switch presses for some functions
    ...
    with open(savename, 'w') as save:
        ...
        if accept_cmsn.ID != cmsn_empty.ID:                    #saving comission
            ...
            if accept_cmsn.prog_item:
                ...
                cnt_save([accept_cmsn.prog_item, accept_cmsn.prog_item_cnt], 'cpkd', 'cpkc')
            
            if accept_cmsn.rew_items[0]:
                t_lis = char2num(accept_cmsn.rew_items[0])
                cnt_save(accept_cmsn.rew_items, 'cpkd', 'cpkc')
...
def load_game(savename):           #function for loading the game
    try:
        with open(savename, 'r') as save:
            ...
            global cmpl_cmsn_total, cmpl_cmsn_rank
            ...
            while line != '':
                ...
                if line in tag_lis:
                    ...
                    t_lis = [temp_cmsn.prog_kill, temp_cmsn.prog_kill_cnt,
                             temp_cmsn.prog_item, temp_cmsn.prog_item_cnt,
                             temp_cmsn.rew_items[0], temp_cmsn.rew_items[1]]
...
#     type_num = 2
    ...
    if type_num in [1, 2, 3]:              #hunt/assasination
        ...
        if type_num != 3:               #if it will be not raid
            ...
            names = hunt_name if _type == 'hunt' else assa_name         #get name templates from either hunt of assasination name list
