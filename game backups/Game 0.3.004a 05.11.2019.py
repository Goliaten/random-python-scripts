            ...
            while z == 0:
                ...
                if x.team == 'allies':
                    ...
                    if a == 1:
                        ...
                        while True:
                            temp_menu = ['Available special attacks', '1. Magic', '2. Skill']
                            ...
                            if l == 1:
                                for y, w in enumerate(known_magic):
                                    if y == 0:
                                        temp_menu = ['Magic:']
                                    temp_menu.append(str(y) + '. ' + w.stat_name + ' fnc:' + w.fnc_name + ' for:' + str(w.value))
                                menu_print(temp_menu)
                                sec_menu = 'Choose magic to cast(type "ex" to quit"): '
                            
                            elif l == 2:
                                for y, w in enumerate(known_skills):
                                    if y == 0:
                                        temp_menu = ['Skills:']
                                    temp_menu.append(str(y) + '. ' + w.stat_name + ' fnc:' + w.fnc_name + ' for:' + str(w.value))
                                menu_print(temp_menu)
...
class sp_skill(sp_atk):
    def __init__(self, name, cost, fnc, fnc_name, value, target, cooldown):
        super().__init__(name, cost, fnc, fnc_name, value, target)
...
sp_doubl_atk = sp_skill('Double attack', 0, spf_doubl_atk, 'atk', 30, 't2', 4)
