                    ...
                    if a == 1:
                        ...
                        while True:
                            ...
                            if x.mana_max != 0 and x.magic: #remove x.magic for old v                     #if character has mana pool
                                ...
                                contr.append(1)
                                y += 1
                            if x.skills:    #if known_skills        #if team(/c/h/a/r/a/c/t/e/r/) knows any skills
...
class Char:
    ID = 400
    def __init__ (self, name, maxhp, atk, atk_var, recr_cost=0, g_drop=0, exp_drop=0, mana_max = 0, defence=0,
...
#--------------------------Characters-------------------------------
Hero = Char('Hero', 70, 10, 1, 100, defence=1, skills=[sp_doubl_atk])        #(name maxhp atk atk_var recruitment_cost=0 g_drop=0 exp_drop=0
Champion = Char('Champion', 90, 9, 2, 100, skills=[sp_str_atk])            #  magic_max=0 defence=0 defence_type='none' weapon=basic armor='basic')
