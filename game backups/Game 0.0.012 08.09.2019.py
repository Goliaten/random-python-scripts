...
#         self.dmg_type_2 = dmg_type_2                #these are defined by weapon.equip() and char.unequip weapon() and same for armor
    ...
    def deal_dmg (self):
        ...
        if settins['1'] == 1:      #for fighting wiht or without type system
...
#----Characters----
Hero = Char('Hero', 70, 10, 1, 100, defence=1)        #name maxhp atk atk_var recr_cost=0 g_drop=0 defence=0 defence_type='none' weapon=basic armor='basic'
        ...
        while True:
            ...
            if a == 2:
                while True:
                    ...
                    print(' 1. Enable/disable damage type usage')
