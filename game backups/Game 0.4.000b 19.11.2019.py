...
sp_heal_all = sp_magic('Heal all', 0, spf_heal_all, 'heal', 30, 'team 1', 20)
...
Mage = Char('Mage', 50, 5, 1, 150, mana_max=100, magic=[sp_heal_all], passive=[sp_pass_heal_all])
                        ...
                        while True:
                            for x in team_1:
                                ...
                                if x.magic:
                                    ...
                                    for y in x.magic:
                                        temp_menu.append(f'  {y.name} for {y.value}, cost:{y.cost}')
