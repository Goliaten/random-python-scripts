...
class Armor:
    def __init__(self, name, ID, cost, defence, defence_type='none'):
        self.name = name
        self.stat_name = stat_len(name, 10)
        self.ID = ID
        self.cost = cost
...
basal = Armor('none', 1501, 0, 0)  #name ID cost defence defence_type='none'
light = Armor('Light', 1502, 50, 2)
medial = Armor('Medial', 1503, 120, 4)
heavy = Armor('Heavy', 1504, 250, 6)
...
team_1 = [Hero, Champion, False]                                                  #defining team 1
team_2 = [monster, demon, False]                                                  #defining team 2
