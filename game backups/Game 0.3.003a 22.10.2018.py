...
#                         t_comm_list.append(x.t_comm)    #-------------work in progress/waiting to be abandoned-------------------
#                         print(x.t_comm)
...
#passive, skill, magic
class sp_atk:
    def __init__(self, name, cost, fnc, value):
        self.name = name
        self.cost = cost
        self.fnc = fnc
        self.value = value
...
class sp_passive(sp_atk):
    def __init__(name, cost, fnc, value, target):
        super().__init__(name, cost, fnc, value)
        self.target = target
    def activate():
        self.fnc(value, self.target)


class sp_skill(sp_atk):
    def __init__(name, cost, fnc, value, cooldown):
        super().__init__(name, cost, fnc, value)
        self.cooldown = cooldown


class sp_magic(sp_at):
    def __init__(name, cost, fnc, value, m_cost):   #m_cost = mana cost
        super().__init__(name, cost, fnc, value)
        self.m_cost = m_cost
        ...
        while True:
            ...
            if a == 1:
                ...
                while True:
                    ...
                    l, z = in_err_ch(l, len(temp_menu)-1)
...
asdefrgthj#try to apply A A A to the menus or dont
            a = input('Choose: ')
