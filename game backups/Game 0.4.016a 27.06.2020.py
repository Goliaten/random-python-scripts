...
sp_m_heal_AT_v3 = SP_magic('Heal all v3', 0, sph_ally_AT, spi_heal, 'heal', 20, 100, 3, None)
sp_m_heal_AT_v2 = SP_magic('Heal all v2', 0, sph_ally_AT, spi_heal, 'heal', 15, 75, 2, sp_m_heal_AT_v3)
sp_m_heal_AT_v1 = SP_magic('Heal all v1', 0, sph_ally_AT, spi_heal, 'heal', 10, 40, 1, sp_m_heal_AT_v2)

sp_p_dmg_ST_v3 = 
sp_p_dmg_ST_v2 = 
sp_p_dmg_ST_v1 = SP_magic('Damage one v1', 0, sph_enem_ST, spi_dmg, 'dmg')

sp_m_dmg_AT_v3 = SP_magic('Damage all v3', 0, sph_enem_AT, spi_dmg, 'dmg', 11, 100, 3, None)
sp_m_dmg_AT_v2 = SP_magic('Damage all v2', 0, sph_enem_AT, spi_dmg, 'dmg', 9,  70, 2, sp_m_dmg_AT_v3)
sp_m_dmg_AT_v1 = SP_magic('Damage all v1', 0, sph_enem_AT, spi_dmg, 'dmg', 7,  50, 1, sp_m_dmg_AT_v2)

#---skill attacks---
               #SP_skill(name, cost, sph, spi, fnc_name, value, cooldown, init_cooldown, level, upgrade):
sp_s_atk_pent = SP_skill('Pentuple attack', 0, sph_enem_ST, spi_atk_multi, 'atk', 5, 6, 4, 4, None)
sp_s_atk_quad = SP_skill('Quaruple attack', 0, sph_enem_ST, spi_atk_multi, 'atk', 4, 5, 3, 3, sp_s_atk_pent)
sp_s_atk_tripl = SP_skill('Triple attack',  0, sph_enem_ST, spi_atk_multi, 'atk', 3, 5, 2, 2, sp_s_atk_quad)
sp_s_atk_doubl = SP_skill('Double attack',  0, sph_enem_ST, spi_atk_multi, 'atk', 2, 3, 1, 1, sp_s_atk_tripl)

sp_s_atk_v4 = SP_skill('Strong attack v4', 0, sph_enem_ST, spi_atk_strong, 'atk', 2.0, 6, 4, 4, None)
sp_s_atk_v3 = SP_skill('Strong attack v3', 0, sph_enem_ST, spi_atk_strong, 'atk', 1.7, 5, 3, 3, sp_s_atk_v4)
sp_s_atk_v2 = SP_skill('Strong attack v2', 0, sph_enem_ST, spi_atk_strong, 'atk', 1.5, 4, 2, 2, sp_s_atk_v3)
sp_s_atk_v1 = SP_skill('Strong attack v1', 0, sph_enem_ST, spi_atk_strong, 'atk', 1.3, 3, 2, 1, sp_s_atk_v2)

sp_s_atk_arm_v4 = SP_skill('Armor piercing attack v4', 0, sph_enem_ST, spi_atk_arm, 'atk', 5, 5, 2, 4, None)
sp_s_atk_arm_v3 = SP_skill('Armor piercing attack v3', 0, sph_enem_ST, spi_atk_arm, 'atk', 4, 4, 2, 3, sp_s_atk_arm_v4)
sp_s_atk_arm_v2 = SP_skill('Armor piercing attack v2', 0, sph_enem_ST, spi_atk_arm, 'atk', 3, 4, 2, 2, sp_s_atk_arm_v3)
sp_s_atk_arm_v1 = SP_skill('Armor piercing attack v1', 0, sph_enem_ST, spi_atk_arm, 'atk', 2, 3, 2, 1, sp_s_atk_arm_v2)

#---passive attacks---
                  #SP_passive(name, cost, sph, spi, fnc_name, value, level, upgrade)
sp_p_heal_AT_v4 = SP_passive('Passive heal allies v4', 0, sph_ally_AT, spi_heal, 'heal', 4, 4, None)
sp_p_heal_AT_v3 = SP_passive('Passive heal allies v3', 0, sph_ally_AT, spi_heal, 'heal', 3, 3, sp_p_heal_AT_v4)
sp_p_heal_AT_v2 = SP_passive('Passive heal allies v2', 0, sph_ally_AT, spi_heal, 'heal', 2, 2, sp_p_heal_AT_v3)
sp_p_heal_AT_v1 = SP_passive('Passive heal allies v1', 0, sph_ally_AT, spi_heal, 'heal', 1, 1, sp_p_heal_AT_v2)

sp_p_dmg_AT_v4 = SP_passive('Passive damage enemies v4', 0, sph_enem_AT, spi_dmg, 'dmg', 4, 4, None)
sp_p_dmg_AT_v3 = SP_passive('Passive damage enemies v3', 0, sph_enem_AT, spi_dmg, 'dmg', 3, 3, sp_p_dmg_AT_v4)
sp_p_dmg_AT_v2 = SP_passive('Passive damage enemies v2', 0, sph_enem_AT, spi_dmg, 'dmg', 2, 2, sp_p_dmg_AT_v3)
sp_p_dmg_AT_v1 = SP_passive('Passive damage enemies v1', 0, sph_enem_AT, spi_dmg, 'dmg', 1, 1, sp_p_dmg_AT_v2)
...
global_magic = [sp_m_heal_AT_v1, sp_m_heal_AT_v2, sp_m_heal_AT_v3,
