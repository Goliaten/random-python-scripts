...
def stat(char, c=0):
    if c == 0:
        print(char.stat_name + '- health:' + char.stat_hp + '/' + char.stat_maxhp + ' attack:' + char.atkmin + '-' + char.atkmax + ' armor:' + str(char.armor))
    elif c == 1:
        if char.weapon == basic:
             print(char.stat_name + '- health:' + char.stat_hp + '/' + char.stat_maxhp + ' attack:' + char.atkmin + '-' + char.atkmax + ' armor:' + str(char.armor) + '  weapon:' + char.weapon.stat_name)           
        else:
            print(char.stat_name + '- health:' + char.stat_hp + '/' + char.stat_maxhp + ' attack:' + char.atkmin + '-' + char.atkmax + ' armor:' + str(char.armor) + '  weapon:' + char.weapon.stat_name + ' dmg:' + str(char.weapon.dmg) + ' var:' + str(char.weapon.dmg_var))
                ...
                while True:
                    ...
                    if held_weapons:         #if you hav any weapon in eq
                        ...
                        for x in held_weapons:                 #printing weapons with stats
                            y += 1
                            print(' ' + str(y) + '. ' + x.stat_name + ': damage:' + str(x.stat_dmg) + '(' + str(x.dmg_var) + ') ' + x.dmg_type_1 + ' ' + x.dmg_type_2)
                        ...
                        try:
                            ...
                            if l < 0 or l > y:
                                print('Choice out of range')
                                continue
                        if team_1[l].weapon != basic:                         #if char already has a weapon
                            ...
                            if a != 'yes':         #only yes will allow  to equip a weapon
                                break
