...
def fight(ally, enem, g_gain=0, exp_gain=0):
    ...
    s = 0
    while z == 0:
        passive_comm = []        #for comment at EoT_summ for passives
        print()
        turn += 1
...
sp_pass_heal = sp_passive('Passive heal', 0, spf_pass_heal, 'heal', 2, 't1')

known_passive = [sp_pass_heal]
