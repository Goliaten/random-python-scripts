...
sp_m_heal_all_v1 = sp_magic('Heal all v1', 0, sph_t1, spi_heal, 'heal', 10, 40)
sp_m_heal_all_v2 = sp_magic('Heal all v2', 0, sph_t1, spi_heal, 'heal', 15, 75)
sp_m_heal_all_v3 = sp_magic('Heal all v3', 0, sph_t1, spi_heal, 'heal', 20, 100)

sp_m_dmg_all_v1 = sp_magic('Damage all v1', 0, sph_t2, spi_dmg, 'dmg', 7,  50)
sp_m_dmg_all_v2 = sp_magic('Damage all v2', 0, sph_t2, spi_dmg, 'dmg', 9,  70)
sp_m_dmg_all_v3 = sp_magic('Damage all v3', 0, sph_t2, spi_dmg, 'dmg', 11, 100)


sp_s_atk_doubl = sp_skill('Double attack',  0, sph_t2_targ, spi_atk_multi, 'atk', 2, 3, 1)
sp_s_atk_tripl = sp_skill('Triple attack',  0, sph_t2_targ, spi_atk_multi, 'atk', 3, 5, 2)
sp_s_atk_quad = sp_skill('Quaruple attack', 0, sph_t2_targ, spi_atk_multi, 'atk', 4, 5, 3)
sp_s_atk_pent = sp_skill('Pentuple attack', 0, sph_t2_targ, spi_atk_multi, 'atk', 5, 6, 4)

sp_s_atk_v1 = sp_skill('Strong attack v1', 0, sph_t2_targ, spi_atk_strong, 'atk', 1.3, 3, 2)
sp_s_atk_v2 = sp_skill('Strong attack v2', 0, sph_t2_targ, spi_atk_strong, 'atk', 1.5, 4, 2)
sp_s_atk_v3 = sp_skill('Strong attack v3', 0, sph_t2_targ, spi_atk_strong, 'atk', 1.7, 5, 3)
sp_s_atk_v4 = sp_skill('Strong attack v4', 0, sph_t2_targ, spi_atk_strong, 'atk', 2.0, 6, 4)


sp_p_heal_all_v1 = sp_passive('Passive heal allies v1', 0, sph_t1, spi_heal, 'heal', 1)
sp_p_heal_all_v2 = sp_passive('Passive heal allies v2', 0, sph_t1, spi_heal, 'heal', 2)
sp_p_heal_all_v3 = sp_passive('Passive heal allies v3', 0, sph_t1, spi_heal, 'heal', 3)
sp_p_heal_all_v4 = sp_passive('Passive heal allies v4', 0, sph_t1, spi_heal, 'heal', 4)

sp_p_dmg_all_v1 = sp_passive('Passive damage enemies v1', 0, sph_t2, spi_dmg, 'dmg', 1)
sp_p_dmg_all_v2 = sp_passive('Passive damage enemies v2', 0, sph_t2, spi_dmg, 'dmg', 2)
sp_p_dmg_all_v3 = sp_passive('Passive damage enemies v3', 0, sph_t2, spi_dmg, 'dmg', 3)
sp_p_dmg_all_v4 = sp_passive('Passive damage enemies v4', 0, sph_t2, spi_dmg, 'dmg', 4)
...
global_skills = [sp_s_atk_doubl, sp_s_atk_tripl, sp_s_atk_quad, sp_s_atk_pent,
...
all_id_class += global_passive + global_skills + global_magic         #for checking all ID
...
class Char:
    def __init__ (self, name, hp_max, atk, atk_var, recr_cost=0, g_drop=0, exp_drop=0, mana_max=0, mana_gain=5, defence=0,
                  defence_type_1='none', weapon=basic, armor=basal, AI=AI_random, skills=[], skill_tree=[], magic=[], magic_tree=[], passive=[], passive_tree=[]):
        global ID
...
#                 'atk': [1, self.base_atk, self.atk, 2, 1],         #, second is stat that is used commonly(----------unused now----------)
