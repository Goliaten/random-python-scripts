...
def stat(char, x=0):
    if x == 0:
        ...
        print(char.stat_name, '- health:', str(char.hp) + '/' + str(char.maxhp), ' attack:', str(char.atkmin) + '-' + str(char.atkmax), ' armor:', char.armor, 'weapon:', char.weapon.name, 'dmg:', char.weapon.dmg, 'var', char.weapon.dmg_var)
...
training_bat = Weapon('Training bat', 1002, 50, 2, 1, 'blunt')
...
Hero = Char('Hero', 50, 10, 1, 0)        #max_hp, atk, atk_var, armor, gold_drop, weapon, damage type
        ...
        while True:
            ...
            if a == 1:
                ...
                while True:
                    ...
                    held_items.pop(o)                      #deleting chosen item from inventory
                    break
