...
#    skill=[], skill_tree=[], magic=[], magic_tree=[], passive=[], passive_tree=[])   #trees as multilayer lists, sp_atk may be multilayer, otherwise normal progression shall be used
...
hero =     Char('Hero',     70,  10, 1, 100, defence=1, skill=[sp_s_atk_doubl, sp_s_atk_v1])
