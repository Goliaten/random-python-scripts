...
sp_m_heal_ST_v3 = SP_magic('Heal one v3', 0, sph_ally_ST, spi_heal, 'heal', 40, 0, 100, 1, None)
sp_m_heal_ST_v2 = SP_magic('Heal one v2', 0, sph_ally_ST, spi_heal, 'heal', 30, 0, 75,  1, sp_m_heal_ST_v3)
sp_m_heal_ST_v1 = SP_magic('Heal one v1', 0, sph_ally_ST, spi_heal, 'heal', 20, 0, 40,  1, sp_m_heal_ST_v2)

sp_m_heal_AT_v3 = SP_magic('Heal all v3', 0, sph_ally_AT, spi_heal, 'heal', 20, 0, 100, 3, None)
sp_m_heal_AT_v2 = SP_magic('Heal all v2', 0, sph_ally_AT, spi_heal, 'heal', 15, 0, 75,  2, sp_m_heal_AT_v3)
sp_m_heal_AT_v1 = SP_magic('Heal all v1', 0, sph_ally_AT, spi_heal, 'heal', 10, 0, 50,  1, sp_m_heal_AT_v2)

sp_m_dmg_ST_v3 = SP_magic('Damage one v3', 0, sph_enem_ST, spi_dmg, 'dmg', 20, 0, 90, 3, None)
sp_m_dmg_ST_v2 = SP_magic('Damage one v2', 0, sph_enem_ST, spi_dmg, 'dmg', 14, 0, 75, 2, sp_m_dmg_ST_v3)
sp_m_dmg_ST_v1 = SP_magic('Damage one v1', 0, sph_enem_ST, spi_dmg, 'dmg', 10, 0, 50, 1, sp_m_dmg_ST_v2)

sp_m_dmg_AT_v3 = SP_magic('Damage all v3', 0, sph_enem_AT, spi_dmg, 'dmg', 10, 0, 100, 3, None)
sp_m_dmg_AT_v2 = SP_magic('Damage all v2', 0, sph_enem_AT, spi_dmg, 'dmg', 8,  0, 70,  2, sp_m_dmg_AT_v3)
sp_m_dmg_AT_v1 = SP_magic('Damage all v1', 0, sph_enem_AT, spi_dmg, 'dmg', 6,  0, 50,  1, sp_m_dmg_AT_v2)
...
test_boi_4 = Char('_test_boi_ 4', 100, 1, 0, mana_max=200, armor=creator_skin,
...
test_boi_5 = Char('_test_boi_ 5', 100, 1, 0, mana_max=1000, mana_gain=100, weapon=creator_touch, armor=creator_skin,
...
test_boi_5b.name += 'b'
test_boi_5c = deepcopy(test_boi_5)
test_boi_5c.name += 'c'

if dev_opt == 'xel':
    global_allies = [hero, champion, mage, assasin, fighter, defender,
                     test_boi_1, test_boi_2, test_boi_3, test_boi_4, test_boi_5, test_boi_5a, test_boi_5b, test_boi_5c]
else:
    global_allies = [hero, champion, mage, assasin, fighter, defender]
...
# after one package of data has been read, '---\n' is used to mark end of data pack
        ...
        while True:
            ...
            if a == 1:
                ...
                fight([test_boi_5, test_boi_5a, test_boi_5b, test_boi_5c], [test_boi_3, test_boi_4])
