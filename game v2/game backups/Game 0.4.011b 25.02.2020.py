                    ...
                    #---------complete (remind of) a comission------------
                        ...
                        while True:
                            ...
                            if a == 1:
                                ...
                                temp_menu = cmsn_info(accept_cmsn, 1)
                                sec_menu = []
                                ...
                                if accept_cmsn.type == 'hunt':
                                    ...
                                    #--------------------------------------
                                    if z == 0:
                                        sec_menu.append('Items, that can be delivered all at once:')
                                        for y in compl_item:
                                        ...
                                        if o != "ex":
                                            ...
                                            for y in compl_item[::-1]:         #getting indexes of items DAAO in reverse, so progress items can be removed from accepted comission here
                                                ...
                                                for z in range(temp_num):           #removing {temp_num} items from the held materials
                                        ...
                                        menu_print(['Not enough items to deliver'])
                                        pause()
                                    
                                    
                                    del temp_cnt, break_num, z, compl_item, temp_num
