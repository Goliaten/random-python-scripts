...
#x and y and z are for 'for' loops
#y is for counter in for loop
#z is another placeholder used in for loop (used first in fight choose print)
        ...
        while True:
            ...
            for x in team_1:
                ...
                if x.hp <= 0:         #can't target for attack/buff/debuff/heal deadman (not here at least)
                    ...
                    continue
                y += 1
                print(str(y) + '. ' + y.stat_name + ' ' + y.stat_hp + '/' + y.stat_maxhp)            #printing team_1 members with indexes
...
def fight(ally, enem, g_gain=0):
    global team_1, team_2, o, p, all_fghtr, turn, held_items
            ...
            while z == 0:
                ...
                if x.team == 'allies':
                    ...
                    if a == 1:
                        ...
                        for x in held_items:
                            y += 1
                            print(str(y) + '. ' + x.stat_name +': function:' + x.fnc_name + ' for:' + str(x.x))
...
def heal(x, c=0):
    ...
    print(y.name + ' has been healed for ' + str(b-l) + ' health up to current ' + str(y.hp) + ' health points')
...
class Item:
    ...
    def use_item (self):
        ...
        held_items.pop(o)   #deleting self from list
    def buy_item (self):
        global gold          #accesing held gold outside of function
        p = 'Are you sure you want to buy: ' + self.name + '? (type "yes" to confirm) '
        a = input(p)
        ...
        while True:
            ...
            if a == 1:
                ...
                while z == 0:
                    ...
                    for x in v:
                        y += 1
                        print(str(y) + '. ' + x.stat_name + ' function:' + x.fnc_name + ' for:' + x.x + 'cost:' + str(x.cost))
                    o = input('Choose (type "ex" to quit): ')
