...
#         continue                         |
#     elif z == 2:                         |
#         break                            |---this part is NEEDED to work properly
#     elif z == 3:                         |
#         m += 1                           |
#     elif z == 4:                         |
#         m -= 1                           /
...
class Cmsn:
    ...
    def __init__(self, name, rank, rew_gold=0, rew_items=[], req_cmsn_stry=[], req_cmsn_cnt=0, req_lvl_max=0, req_lvl_sum=0, req_team_cnt=0):
        ...
        self.rew_gold = rew_gold    #gold reward
        self.rew_items = rew_items     #item rewards
        
        self.req_cmsn_stry = req_cmsn_stry        #defines which previous story comissions have to be completed
...
# -search()  <-- with modified/expanded/overhauled encounter/world structure this will have more sense
...
cmsn_slot_1 = Cmsn('slot 1', 0)
cmsn_slot_2 = Cmsn('slot 2', 0)
cmsn_slot_3 = Cmsn('slot 3', 0)
cmsn_slot_4 = Cmsn('slot 4', 0)
        ...
        while True:
            ...
            if a == 1:
                ...
                while True:
                    ...
                    if a == 1:
                        menu_print(['In progress'])
                        
                        pause()
                        pass
                        
                    elif a == 2:
                        menu_print['Unavailable for now']
                        pause()
                        pass
