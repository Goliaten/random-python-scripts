...
cmsn_story_3 = Cmsn('Third task',  2, 'gathering', [], [], ['Iron Nugget', 'Iron Ingot'], [3, 1], 80, ['Iron Ingot', 'Iron Ingot'])
...
cmsn_slot_1 = Cmsn('slot 1', 0, 'slot')
cmsn_slot_2 = Cmsn('slot 2', 0, 'slot')
cmsn_slot_3 = Cmsn('slot 3', 0, 'slot')
cmsn_slot_4 = Cmsn('slot 4', 0, 'slot')
            ...
            if a == 1:
                ...
                while True:
                    temp_menu = ['Clerk: "Welcome to the comission counter.',
                                 '        How can I help you?"',
                                 ' 1. Available comission',
                                 ' 2. Accepted comission',
                        ...
                        while True:
                            ...
                            if a == 1:
                                ...
                                if x.type == 'hunt':          #if it's hunting comission
                                    ...
                                    out += 'assasinate'
                                    for l, z in enumerate(x.cmpl_kill):
                                        out += f' {z}'
                                ...
                                temp_menu.append(out)
                                
                                
                                temp_menu.append('Rewards: ' if (x.rew_gold or x.rew_items) else 'Rewards: None')  #add this to table if reward is present, else add that
                                
                                temp_menu.append(f' gold:{x.rew_gold}' if x.rew_gold else '')
...
#                         for y, x in enumerate(cmsn_story):             #going over story comissions
#                             out = f' {y}. {x.name}:'
#                             
#                             if x.type == 'hunt':          #if it's hunting comission
#                                 out += ' kill'
...
#                             
#                             
#                             out += f", reward in gold:{x.rew_gold};" if x.rew_gold > 0 else ''
#                             
#                             if x.rew_items:
#                                 for l, z in enumerate(x.rew_items):
#                                     if l == 0:
